                  ...
                  <div className='row g-4'>
                    ...
                    <div className='col-lg-4 col-md-6'>
                      <div className='card-servies-2 rounded-2 h-100 hover-up'>
                        ...
                        <h6 className='my-3 fw-medium'>UI Library</h6>
                        <p className='fs-7 text-300 fw-regular'>
                          Designing and managing websites with UI Library such
                          as <span className='text-secondary-2'>MUI</span>,{' '}
                          <span className='text-secondary-2'>ChakraUI</span>,
                          and <span className='text-secondary-2'>others</span>.
                        </p>
                      </div>
                    </div>
                    <div className='col-lg-4 col-md-6'>

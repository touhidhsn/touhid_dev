                      ...
                      <li className='position-relative z-1 mb-3'>
                        <div className='d-flex gap-2'>
                          ...
                          <div>
                            ...
                            <p className='text-dark'>Science</p>
                          </div>
                        </div>
                      </li>
                      <li className='position-relative z-1 mb-3'>
            ...
            <div className='col-lg-6 pt-3'>
              <div className='bg-3 rounded-3 border border-1 p-md-6 p-3 position-relative h-100 overflow-hidden'>
                <div className='d-flex align-items-center'>
                  ...
                  <h2 className='mb-0 ms-2'>Online Courses</h2>
                </div>
                <div className='d-flex flex-column h-100 position-relative mt-5'>
                  <ul className='ps-3'>
                    <li className='position-relative z-1 mb-3'>
                      <div className='d-flex gap-2'>
                        ...
                        <div>
                          ...
                          <p className='text-dark'>Mosh Online Course</p>
                        </div>
                      </div>
                    </li>
                    <li className='position-relative z-1 mb-3'>
                      <div className='d-flex gap-2'>
                        ...
                        <div>
                          ...
                          <p className='text-dark'>Namaste Javascript</p>
                        </div>
                      </div>
                    </li>
                    <li className='position-relative z-1 mb-3'>
                      <div className='d-flex gap-2'>
                        ...
                        <div>
                          <span className='text-primary-2'>Basic Node JS</span>
                          <p className='text-dark'>Mosh Online Course</p>
                        </div>
                      </div>
                    </li>

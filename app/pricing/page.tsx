                ...
                <div className='col-lg-8 mx-lg-auto mb-8'>
                  <div className='text-center'>
                    ...
                    <h3 className='ds-3 mt-3 mb-4 text-dark'>
                      Affordable{' '}
                      <span className='text-300'>Solutions for Every</span>{' '}
                      Budget
                    </h3>
                    <p className='text-300 fs-5 mb-0'>
                      Flexible Plans Tailored to Meet Your Unique Needs,
                      Ensuring High-Quality Services <br />
                  ...
                  <div className='row mt-8 d-flex'>
                    <div className='col-md-6'>
                      <div className='card-pricing-1 p-6 rounded-4 h-100 d-flex flex-column'>
                        <span className='text-uppercase fs-7'>basic</span>{' '}
                        <br />
                        ...
                        <ul className='ps-3 border-top border-600 pt-5 mb-auto'>
                          ...
                          <li>
                            <p className='text-300'>
                              Develop with Webflow, React, WordPress,
                              Laravel/PHP
                            </p>
                          </li>
                          <li>
                    ...
                    <div className='col-md-6'>
                      <div className='card-pricing-1 p-6 rounded-4 align-self-stretch mt-md-0 mt-6'>
                        <span className='text-uppercase fs-7'>Business</span>{' '}
                        <br />
                        <h3 className='ds-3 fw-medium text-primary mb-5'>
                  ...
                  <div className='accordion'>
                    <div className='mb-3 card border-2 rounded-4'>
                      <div className='card-header p-0 border-0'>
                        <Link
                          className='p-3 collapsed text-900 fw-bold d-flex align-items-center'
                      ...
                      <div
                        ...
                        <p className='px-4 pt-0 text-start card-body'>
                          ...
                          efficient choices in your custom home. Federal tax
                          credits for some green materials can allow you to
                          deduct as much.
                        </p>
                      </div>
                    </div>
                    <div className='mb-3 card border-2 rounded-4'>
                      <div className='card-header p-0 border-0'>
                        <Link
                          ...
                          href='/#collapseEight'>
                          <p className='fs-5 mb-0 text-dark'>
                            Will you include a blog or other written content?
                          </p>
                          <span className='ms-auto arrow me-2 icon-shape'>
                            <i className='ri-add-line' />
                          </span>

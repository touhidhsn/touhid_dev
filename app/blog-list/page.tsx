                  ...
                  <div className='blog-card rounded-4 mb-lg-3 mb-md-5 mb-3'>
                    <div className='blog-card__image position-relative'>
                      <div className='zoom-img rounded-3 overflow-hidden'>
                        <img
                          className='w-100'
                          src='/assets/imgs/blog/blog-1/img-4.png'
                          alt=''
                        />
                        <Link
                          className='position-absolute bottom-0 start-0 m-3 text-white-keep btn btn-gradient fw-medium rounded-3 px-3 py-2'
                  ...
                  <div className='blog-card rounded-4 mb-lg-3 mb-md-5 mb-3'>
                    <div className='blog-card__image position-relative'>
                      <div className='zoom-img rounded-3 overflow-hidden'>
                        <img
                          className='w-100'
                          src='/assets/imgs/blog/blog-1/img-5.png'
                          alt=''
                        />
                        <Link
                          className='position-absolute bottom-0 start-0 m-3 text-white-keep btn btn-gradient fw-medium rounded-3 px-3 py-2'
                  ...
                  <div className='blog-card rounded-4 mb-lg-3 mb-md-5 mb-3'>
                    <div className='blog-card__image position-relative'>
                      <div className='zoom-img rounded-3 overflow-hidden'>
                        <img
                          className='w-100'
                          src='/assets/imgs/blog/blog-1/img-6.png'
                          alt=''
                        />
                        <Link
                          className='position-absolute bottom-0 start-0 m-3 text-white-keep btn btn-gradient fw-medium rounded-3 px-3 py-2'
                  ...
                  <div className='blog-card rounded-4 mb-lg-3 mb-md-5 mb-3'>
                    <div className='blog-card__image position-relative'>
                      <div className='zoom-img rounded-3 overflow-hidden'>
                        <img
                          className='w-100'
                          src='/assets/imgs/blog/blog-1/img-7.png'
                          alt=''
                        />
                        <Link
                          className='position-absolute bottom-0 start-0 m-3 text-white-keep btn btn-gradient fw-medium rounded-3 px-3 py-2'
                  ...
                  <div className='blog-card rounded-4 mb-lg-3 mb-md-5 mb-3'>
                    <div className='blog-card__image position-relative'>
                      <div className='zoom-img rounded-3 overflow-hidden'>
                        <img
                          className='w-100'
                          src='/assets/imgs/blog/blog-1/img-8.png'
                          alt=''
                        />
                        <Link
                          className='position-absolute bottom-0 start-0 m-3 text-white-keep btn btn-gradient fw-medium rounded-3 px-3 py-2'
                  ...
                  <div className='blog-card rounded-4 mb-lg-3 mb-md-5 mb-3'>
                    <div className='blog-card__image position-relative'>
                      <div className='zoom-img rounded-3 overflow-hidden'>
                        <img
                          className='w-100'
                          src='/assets/imgs/blog/blog-1/img-9.png'
                          alt=''
                        />
                        <Link
                          className='position-absolute bottom-0 start-0 m-3 text-white-keep btn btn-gradient fw-medium rounded-3 px-3 py-2'

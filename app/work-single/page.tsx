              ...
              <div className='row'>
                <div className='col-lg-8 mx-lg-auto mb-lg-0'>
                  <div className='text-center'>
                    ...
                    <p className='text-300 fs-5 mb-0'>
                      The project involved creating an intuitive and visually
                      appealing user interface, ensuring that users can
                      effortlessly book flights, hotels, and car rentals all
                      within a single app.
                    </p>
                  </div>
                </div>
                ...
                <div className='col-lg-8 mx-lg-auto mt-8'>
                  ...
                  <p className='text-300'>
                    Travila is a comprehensive travel booking app designed to
                    provide users with a seamless and enjoyable booking
                    experience. The project involved creating an intuitive and
                    visually appealing user interface, ensuring that users can
                    effortlessly book flights, hotels, and car rentals all
                    within a single app. The primary goal was to enhance the
                    overall user experience, making travel planning easy and
                    enjoyable.
                  </p>
                  ...
                  <ul>
                    <li>
                      <p className='text-dark fw-bold'>
                        ...
                        <span className='text-300 fw-medium'>
                          Designed a clean and intuitive interface that allows
                          users to navigate through the app with ease, ensuring
                          a smooth and enjoyable booking process.
                        </span>
                      </p>
                    </li>
                    <li>
                      <p className='text-dark fw-bold'>
                        Integrated Search and Booking:{' '}
                        <span className='text-300 fw-medium'>
                          Developed an integrated search function that enables
                          users to find and book flights, hotels, and car
                          rentals quickly and efficiently.
                        </span>
                      </p>
                    </li>
                    <li>
                      <p className='text-dark fw-bold'>
                        ...
                        <span className='text-300 fw-medium'>
                          Implemented a recommendation system that suggests
                          destinations, accommodations, and activities based on
                    ...
                    <li>
                      <p className='text-dark fw-bold'>
                        ...
                        <span className='text-300 fw-medium'>
                          Integrated a secure payment gateway to ensure that all
                          transactions{' '}
                          <span className='text-dark fw-bold'>
                            are safe and user data is protected.
                          </span>
                        </span>
                      </p>
                    </li>
                    <li>
                      <p className='text-dark fw-bold'>
                        Interactive Maps:{' '}
                        <span className='text-300 fw-medium'>
                          Added interactive maps to help users explore
                          destinations, find nearby attractions, and get
                          directions.
                        </span>
                      </p>
                    </li>
                  ...
                  <ul>
                    <li>
                      <p className='text-dark fw-bold'>
                        ...
                        <span className='text-300 fw-medium'>
                          ...
                          ensuring a consistent experience on both iOS and
                          Android devices.
                        </span>
                      </p>
                    </li>
                    <li>
                      <p className='text-dark fw-bold'>
                        Back-End:{' '}
                        <span className='text-300 fw-medium'>
                          Node.js and Express for handling server-side logic and
                    ...
                    <li>
                      <p className='text-dark fw-bold'>
                        APIs:{' '}
                        <span className='text-300 fw-medium'>
                          Integrated third-party APIs for flight, hotel, and car
                          rental bookings to provide a wide range of options to
                          users.
                        </span>
                      </p>
                    </li>
                  ...
                  <ul>
                    <li>
                      <p className='text-dark fw-bold'>
                        Visual Appeal:{' '}
                        <span className='text-300 fw-medium'>
                          Focused on a visually appealing design with
                          high-quality images and a modern color palette to
                    ...
                    <li>
                      <p className='text-dark fw-bold'>
                        Usability:{' '}
                        <span className='text-300 fw-medium'>
                          Ensured the app is user-friendly with clear icons,
                          concise labels, and a straightforward navigation
                          structure.
                        </span>
                      </p>
                    </li>
                    <li>
                      <p className='text-dark fw-bold'>
                        Responsive Design:{' '}
                        <span className='text-300 fw-medium'>
                          Made the app responsive to different screen sizes and
                          orientations, providing a consistent user experience

                      ...
                      <div className='card__inner bg-6 p-lg-6 p-md-4 p-3'>
                        ...
                        <div className='card__content px-md-4 px-3'>
                          ...
                          <p className='text-300 mb-lg-auto mb-md-4 mb-3'>
                            Designed an interactive and engaging educational
                            platform aimed at improving online learning
                            experiences. This included developing intuitive
                            navigation, interactive course materials, and
                            features that support student engagement and
                            participation, making learning more accessible and
                            enjoyable.
                          </p>
                          <div className='d-md-flex content'>
                            <p className='mb-0 fs-7 text-dark text-uppercase w-40'>
                    ...
                    <div className='card-custom' data-index={0}>
                      <div className='card__inner bg-6 p-lg-6 p-md-4 p-3'>
                        <div className='card__image-container zoom-img position-relative'>
                          <img
                            className='card__image'
                            src='/assets/imgs/work/img-3.png'
                            alt=''
                          />
                          <Link
                            href='/work-single'
                    ...
                    <div className='card-custom' data-index={0}>
                      <div className='card__inner bg-6 p-lg-6 p-md-4 p-3'>
                        <div className='card__image-container zoom-img position-relative'>
                          <img
                            className='card__image'
                            src='/assets/imgs/work/img-4.png'
                            alt=''
                          />
                          <Link
                            href='/work-single'
